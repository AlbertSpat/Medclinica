...
@section("content")
    ...
    <div class="container cont-reg">
        <h1>Форма для регистрации пациента</h1>
        <div>
        <img class="img-reg-t" src="img/reg.jpg" alt="">
        </div>

        <form action="{{ route('register.store') }}" method="POST">
            @csrf

            <div class="row row-regt">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>Имя:</strong>
                        <input type="text" name="name" class="form-control"  value="{{old('name')}}" placeholder="Иван">
                        @error('name')
                    <small>{{ $message }}</small>
                        @enderror
                    </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="surname" class="form-control"  value="{{old('surname')}}" placeholder="Иванов">
                        @error('surname')
                    <small>{{ $message }}</small>
                        @enderror
                    </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>Полис:</strong>
                        <input type="text" name="police" class="form-control"  value="{{old('police')}}" placeholder="Полис">
                        @error('police')
                    <small>{{ $message }}</small>
                        @enderror
                    </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="date" name="bithday" class="form-control"  value="{{old('bithday')}}" placeholder="08.07.2000">
                        @error('bithday')
                    <small>{{ $message }}</small>
                        @enderror
                    </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>Пол:</strong>
                        <input type="text" name="pol" class="form-control"  value="{{old('pol')}}" placeholder="Пол">
                        @error('pol')
                    <small>{{ $message }}</small>
                        @enderror
                    </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>Адрес:</strong>
                        <input type="text" name="adres" class="form-control"  value="{{old('adres')}}" placeholder="Адрес">
                        @error('adres')
                    <small>{{ $message }}</small>
                        @enderror
                    </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="phone" class="form-control" value="{{old('phone')}}" placeholder="+7(8) 999 011 10 75">
                        @error('phone')
                    <small>{{ $message }}</small>
                        @enderror
                    </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                    <button type="submit" class="btn btn-primary" style="margin-top: 30px;">Зарегистрироваться</button>
                </div>
